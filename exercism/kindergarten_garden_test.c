...
static void test_partial_garden_different_garden_with_single_student(void) {
  const plants_t expected = {.plants = {VIOLETS, CLOVER, RADISHES, CLOVER}};
...
static void test_full_garden_for_alice_first_student_s_garden(void) {
  const plants_t expected = {.plants = {VIOLETS, RADISHES, VIOLETS, RADISHES}};
...
static void test_full_garden_for_david(void) {
  const plants_t expected = {.plants = {RADISHES, VIOLETS, CLOVER, RADISHES}};
  test_kindergarten_garden("VRCGVVRVCGGCCGVRGCVCGCGV\n"
                           "VRCCCGCRRGVCGCRVVCVGCGCV",
                           "David", expected);
}
...
static void test_full_garden_for_harriet(void) {
  const plants_t expected = {.plants = {VIOLETS, RADISHES, RADISHES, VIOLETS}};
  test_kindergarten_garden("VRCGVVRVCGGCCGVRGCVCGCGV\n"
                           "VRCCCGCRRGVCGCRVVCVGCGCV",
                           "Harriet", expected);
}
