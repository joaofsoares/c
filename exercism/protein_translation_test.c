...
#include "protein_translation.c"

void setUp(void) {}

void tearDown(void) {}

void assert_protein_match(protein_t expected, protein_t actual) {
...
void test_empty_rna_sequence_results_in_no_protein(void) {
  protein_t expected = {
      .valid = true,
      .count = 0,
  };
...
void test_sequence_of_two_protein_codons_translates_into_protein(void) {
  protein_t expected = {
      .valid = true,
      .count = 2,
...
void test_sequence_of_two_different_protein_codons_translates_into_protein(
    void) {
  protein_t expected = {
      .valid = true,
      .count = 2,
...
void test_translation_stops_if_stop_codon_at_end_of_two_codon_sequence(void) {
  protein_t expected = {
      .valid = true,
      .count = 1,
      .amino_acids = {Tryptophan},
...
void test_translation_stops_if_stop_codon_at_end_of_three_codon_sequence(void) {
  protein_t expected = {
      .valid = true,
      .count = 2,
...
void test_translation_stops_if_stop_codon_in_middle_of_three_codon_sequence(
    void) {
  protein_t expected = {
      .valid = true,
      .count = 1,
...
void test_translation_stops_if_stop_codon_in_middle_of_six_codon_sequence(
    void) {
  protein_t expected = {
      .valid = true,
      .count = 3,
...
void test_sequence_of_two_non_stop_codons_does_not_translate_to_a_stop_codon(
    void) {
  protein_t expected = {
      .valid = true,
      .count = 2,
...
void test_non_existing_codon_cant_translate(void) {
  protein_t expected = {
      .valid = false,
  };
...
void test_invalid_codon_cant_translate(void) {
  protein_t expected = {
      .valid = false,
  };
...
void test_incomplete_rna_sequence_can_translate_if_valid_until_a_stop_codon(
    void) {
  protein_t expected = {
      .valid = true,
      .count = 2,
...
int main(void) {
  ...
  RUN_TEST(
      test_sequence_of_two_different_protein_codons_translates_into_protein);
  ...
  RUN_TEST(
      test_translation_stops_if_stop_codon_in_middle_of_three_codon_sequence);
  RUN_TEST(
      test_translation_stops_if_stop_codon_in_middle_of_six_codon_sequence);
  RUN_TEST(
      test_sequence_of_two_non_stop_codons_does_not_translate_to_a_stop_codon);
  ...
  RUN_TEST(
      test_incomplete_rna_sequence_can_translate_if_valid_until_a_stop_codon);
