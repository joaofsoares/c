...
void test_sequence_of_two_different_protein_codons_translates_into_protein(void) {
   protein_t expected = {
      .valid = true,
      .count = 2,
...
void test_translation_stops_if_stop_codon_in_middle_of_three_codon_sequence(void) {
   protein_t expected = {
      .valid = true,
      .count = 1,
      .amino_acids = { Tryptophan },
...
void test_translation_stops_if_stop_codon_in_middle_of_six_codon_sequence(void) {
   protein_t expected = {
      .valid = true,
      .count = 3,
...
void test_sequence_of_two_non_stop_codons_does_not_translate_to_a_stop_codon(void) {
   protein_t expected = {
      .valid = true,
      .count = 2,
